...
Status: **Phase Stitch approved for a standalone mocked implementation**
...
- Select **Phase Stitch** for the standalone mocked implementation.
...
The implementation is still mocked. Its activity wording, disconnect grace
period, ephemeral retention policy, and eventual transport remain provisional
until the runtime owns complete device and session truth.
