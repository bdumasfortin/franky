...
- [ADR-0005: Use the OpenAI API behind a replaceable conversation provider](0005-use-openai-api-behind-provider.md) — Superseded as the current provider by ADR-0009; optional adapter retained.
...
- [ADR-0009: Use local Ollama for the current conversation provider](0009-use-local-ollama-for-current-conversation-provider.md) — Accepted.
